...
//    private UserUI userUI = new UserUI();
    GridContextMenu<Employee> gridContextMenu;
...
//        this.userUI.init(vaadinRequest);

        CssLayout panel = createPanelLayout();
        
        HorizontalLayout toolbar = new HorizontalLayout(createFilteringLayout());        
        ...
        VerticalLayout tabUsers = new VerticalLayout(toolbar, main);
        
        tabSheet.addTab(tabUsers, "Пользователи");
        tabSheet.addTab(new VerticalLayout(), "Опросы");  
       

        tabSheet.setSizeFull();      
        layout.addComponents(panel, tabSheet);
...
//            grid.getEditor().setEnabled(true);
    ...
    @VaadinServletConfiguration(ui = MyUI.class, productionMode = false, widgetset = "com.mycompany.projectvaadin.AppWidgetSet")
